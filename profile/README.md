...
Nếu có ghi chú của các tập tin trong repository ghi rằng tập tin được cấp phép dưới các giấy phép khác (ví dụ như GNU General Public License hoặc các giấy phép tương tự), xin hãy đọc và tuân thủ các điều khoản của giấy phép đó khi muốn tái sử dụng hoặc việc gì đó tương đương. Nếu không có bất kì ghi chú nào trong các tập tin của repository, tập tin đó được mặc định cấp phép theo giấy phép CC BY-SA 4.0.
